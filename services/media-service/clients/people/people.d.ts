...
declare namespace people {
  ...
  type GetPeopleResponses = 
    Array<GetPeopleResponseOK>
  ...
  type UpdatePeopleResponses = 
    Array<UpdatePeopleResponseOK>
